...
/****
 * Structure used to describe the geometry and optical [几何光学]
...
class LayerClass {
	...
	friend void PhotonClass::launch(double Rspecular, vector<LayerClass>& LayerVec);
	friend void PhotonClass::stepSizeInGlass(const InputClass& In);
	friend void PhotonClass::stepSizeInTissue(const InputClass& In);
	friend bool PhotonClass::hitBoundary(const InputClass& In);
	friend void PhotonClass::drop(const InputClass& In, OutClass& Out);
	friend void PhotonClass::recordWeightFirstLayer(double Refl, const InputClass& In, OutClass& Out);
	friend void PhotonClass::recordWeightLastLayer(double Refl, const InputClass& In, OutClass& Out);
	friend void PhotonClass::crossUpOrNot(const InputClass& In, OutClass& Out);
	friend void PhotonClass::crossDownOrNot(const InputClass& In, OutClass& Out);
	friend void PhotonClass::crossOrNot(const InputClass& In, OutClass& Out);
	friend void PhotonClass::hopInGlass(const InputClass& In, OutClass& Out);
	friend void PhotonClass::hopDropSpinInTissue(const InputClass& In, OutClass& Out);
	friend void PhotonClass::hopDropSpin(const InputClass& In, OutClass& Out);
 ...
 * z and r represent z and r coordinates of the [圆柱坐标系的坐标]
